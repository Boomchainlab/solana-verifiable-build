...
// interacting with the agu-token API. You should not instantiate this client
...
// AGU_TOKEN_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("AGU_TOKEN_BASE_URL"); ok {
...
// environment (PETSTORE_API_KEY, AGU_TOKEN_BASE_URL). The option passed in as
